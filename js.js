...
inputText(firstName, /^[a-zA-Z]*$/, '.firstName input');
inputText(lastName, /^[a-zA-Z]*$/, '.lastName input');
inputText(UserName, /^.*@.*\.*$/, '.userName div input');
inputText(City, /^[a-zA-Z]*$/, '.City input');
inputText(State, /^[a-zA-Z]*$/, '.State input');
inputText(Zip, /^[0-9]*$/, '.Zip input');
